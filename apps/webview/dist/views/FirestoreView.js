...
export const FirestoreView = ({ connection, collections, documents, selectedDocument, loading, error, pagination, onLoadDocuments, onOpenDocument, onCloseDocument, onRunQuery, onCreateDocument, onUpdateDocument, onDeleteDocument, onExportCollection, onImportCollection, }) => {
    ...
    return (_jsxs("div", { style: { display: 'flex', height: '100%', overflow: 'hidden' }, children: [_jsxs("div", { style: {
                    width: sidebarWidth,
                    minWidth: 200,
                    maxWidth: 500,
                ...
                }, children: [_jsxs("div", { className: "toolbar", children: [_jsx("button", { onClick: handleNewDocument, title: "New Document (Ctrl+N)", children: "+ Document" }), _jsx("button", { onClick: () => setShowQueryBuilder(!showQueryBuilder), title: "Query Builder", children: "\uD83D\uDD0D Query" }), _jsx("button", { onClick: handleExport, title: "Export Collection", children: "\uD83D\uDCE4 Export" }), _jsx("button", { onClick: handleImport, title: "Import Collection", children: "\uD83D\uDCE5 Import" })] }), showQueryBuilder ? (_jsx(QueryBuilder, { collections: collections, onRunQuery: handleRunQuery, onClose: () => setShowQueryBuilder(false) })) : (_jsx(CollectionTree, { collections: collections, selectedCollection: selectedCollection, onSelect: handleCollectionClick, loading: loading }))] }), _jsx("div", { style: {
                    width: 6,
                    cursor: 'col-resize',

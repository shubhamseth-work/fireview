...
export type FirestoreValue = string | number | boolean | null | TimestampValue | ReferenceValue | GeoPointValue | BytesValue | ArrayValue | MapValue;
...
export declare function isFirestoreValue(value: unknown): value is FirestoreValue;
export declare function serializeFirestoreValue(value: FirestoreValue): unknown;
export declare function deserializeFirestoreValue(value: unknown): FirestoreValue;
...
export type MigrationStep = 'select-source' | 'select-destination' | 'select-data' | 'preview' | 'review-changes' | 'confirm' | 'execute' | 'results';
